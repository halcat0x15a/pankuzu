"use strict";
function intersects(block, ball) {
...
function moveBar(state, cursorX) {
...
function updateSceneStart(state) {
...
function updateSceneGame(state) {
    const cursorX = getCursorX();
    state = moveBar(state, cursorX);
...
function updateSceneClear(state) {
    return state;
}
...
function mainLoop(lastTick, tickLength, tFrame, ctx, state) {
